...
kansen en risico's voor HCC te signaleren, en namens HCC standpunten in te nemen.""",
        "vraag_focus": [
            "Wat zijn de gevolgen van dit agendapunt voor HumanCapitalCare?",
            "Welke informatie heeft Martin nodig om namens HCC een standpunt in te nemen?",
            "Zijn er belangen van HCC die beschermd of ingebracht moeten worden?",
        ],
    },
    "LMT": {
        "label": "LMT",
...
en dat acties worden belegd bij de juiste personen.""",
        "vraag_focus": [
            "Hoe kan Martin dit agendapunt efficiënt leiden?",
            "Welke beslissing moet er worden genomen en wie moet daarvoor iets aanleveren?",
            "Zijn er potentiële spanningen of discussiepunten waar Martin op moet anticiperen?",
        ],
    },
    "RvC iPractice": {
        "label": "RvC iPractice",
        ...
        "is_voorzitter": True,
        "logo": "assets/logo_ipractice.webp",
...
Als voorzitter RvC stelt hij kritische vragen aan het bestuur en zorgt hij dat de RvC zijn toezichthoudende taak goed uitvoert.""",
        "vraag_focus": [
            "Voldoet het bestuur aan zijn verantwoordingsplicht op dit punt?",
            "Zijn er risico's of rode vlaggen vanuit governance- of financieel perspectief?",
    ...
    "RvC Sportbedrijf Deventer": {
        ...
        "is_voorzitter": True,
        "logo": "assets/logo_sportbedrijf.svg",
